...
public class GUI extends JFrame {
    ...
    public void addComponents() {
        ...
        // (1f) Add the output box with the tutorial information
        infoBox.add(new JLabel(" "));
        infoBox.add(l1);
        infoBox.add(l2);
        infoBox.add(Box.createGlue());

        // (1g) Add these rows to the first column
        col1.add(addWHelp);
        col1.add(addPHelp);
        col1.add(addAHelp);
        col1.add(addRHelp);
        ...
        // TODO: Write method evaluate in class Modal
        ...
        evalFormula.addActionListener(e -> {
            ...
            if (w == null) {
                ...
                giveInfo(formula + " is " + w.isValid(formula) + " at " + worldAt,
                    " or " + formula + " is not a valid formula. ");
            }
        });
        col2.add(evalHelp);
